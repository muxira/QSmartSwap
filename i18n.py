STRINGS = {
    "ru": {
        ...
        "autoexit": "Выйти вместе с игрой (следить за cs2.exe)",
        ...
        "rules_then": "Взять",
        "fallback_primary": "Fallback: нет основного — брать пистолет",
        "pistol_fallback_label": "Нет пистолета — брать:",
        "pf_primary": "Основное",
        "pf_knife": "Нож",
        "pf_nothing": "Ничего",
    ...
    "en": {
        ...
        "autoexit": "Exit with the game (watch cs2.exe)",
        ...
        "rules_if": "If active",
        "rules_then": "Take",
        "fallback_primary": "Fallback: no primary — take pistol",
        "pistol_fallback_label": "No pistol — take:",
        "pf_primary": "Primary",
        "pf_knife": "Knife",
        "pf_nothing": "Nothing",
